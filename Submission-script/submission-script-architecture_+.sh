...
work_directory="/home/users/j/jacsont/Varios-OCR-files/Models/Models-HTR-Varios/Alto/GT+varios_4"
mkdir -p ${work_directory}
cd ${work_directory}

OUTPUT_NAME="Data+varios_4"
XML_FOLDER="/home/users/j/jacsont/Varios-OCR-files/Grountruth/GT+varios/"
echo "KETOS training"
